...
//   return (
//     <div className="employee-page-dashboard">
...
//         </button>
//       </div>
//       <div className={styles['employee-dashboard-blocks']}>
//         <div className={styles['employee-dashboard-block']}>
//           <div className={styles['employee-dashboard-block-label']}>Today's In Time</div>
//           <div className={styles['employee-dashboard-block-value']}>{formatWithSeconds('09:00', blockSeconds[0])}</div>
//         </div>
//         <div className={styles['employee-dashboard-block']}>
//           <div className={styles['employee-dashboard-block-label']}>Today's Break Time</div>
//           <div className={styles['employee-dashboard-block-value']}>{formatWithSeconds('00:45', blockSeconds[1])}</div>
//         </div>
//         <div className={styles['employee-dashboard-block']}>
//           <div className={styles['employee-dashboard-block-label']}>Today's Work Time</div>
//           <div className={styles['employee-dashboard-block-value']}>{formatWithSeconds('08:15', blockSeconds[2])}</div>
//         </div>
//         <div className={styles['employee-dashboard-block']}>
//           <div className={styles['employee-dashboard-block-label']}>Today's Over Time</div>
//           <div className={styles['employee-dashboard-block-value']}>{formatWithSeconds('00:30', blockSeconds[3])}</div>
//         </div>
//       </div>
...
// Import all pages for employee
import EmpDashboard from "../EmployeePages/EmpDashboard";
import Profile from "../EmployeePages/EmpProfile"
import Attendance from "../EmployeePages/EmpAttendence"
import Leave from "../EmployeePages/EmpLeave"
import Payslips from "../EmployeePages/EmpPayslips"
import Announcements from "../EmployeePages/EmpAnnouncement"
...
export default function EmployeeMainDashboard() {
  ...
  const ActivePage = employeePages[section] || (() => <div />);
